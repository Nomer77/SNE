...
async def command_start(message: types.Message):
    if message.from_user.id == message.chat.id:
        ...
        await message.answer(f"{message.from_user.full_name}, Добро пожаловать!", reply_markup=markup.checkout())
...
def register_handlers_commands(dp: Dispatcher):
    ...
    dp.register_message_handler(command_menu, lambda message: message.text == "Вызвать меню", state='*')
